...
void createCenterWordSheet(BuildContext context) {
  showDialog(
      context: context,
          ...
          child: Column(
            ...
            children: [
              ...
              FloatingActionButton.extended(
                ...
                onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context)=>LearnWordWindow()));},
              ),
              const SizedBox(
                height: 20,
              ),
              FloatingActionButton.extended(
                ...
                foregroundColor: Colors.white,// <-- Text
                backgroundColor: const Color(0xFFC71A4F),
                onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context)=>WordWindow()));},
              ),
              const SizedBox(
                height: 20,
              ),
